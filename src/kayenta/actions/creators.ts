...
export const updateDatadogGroupBy = createAction<IUpdateListPayload>(Actions.UPDATE_DATADOG_GROUP_BY_FIELDS)
...
export const updateDatadogMetricDescriptorFilter = createAction<{filter: string}>(Actions.UPDATE_DATADOG_METRIC_DESCRIPTOR_FILTER);
export const updateStackdriverMetricType = createAction<{metricType: string}>(Actions.UPDATE_STACKDRIVER_METRIC_TYPE);
export const updateDatadogMetricType = createAction<{metricType: string}>(Actions.UPDATE_DATADOG_METRIC_TYPE);
