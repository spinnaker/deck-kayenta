...
export const UPDATE_SIGNAL_FX_METRIC_NAME = 'update-signalfx-metric-name';
export const UPDATE_SIGNAL_FX_AGGREGATION_METHOD = 'update-signalfx-aggregation-method';
export const UPDATE_SIGNAL_FX_QUERY_PAIRS = 'update-signalfx-query-pairs';
